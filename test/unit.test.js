...
describe("Configuration Tests", () => {
  ...
  test("should validate configuration", () => {
    const invalidOutput = validateConfig({
      engine: "auto",
      output: "invalid",
      temperature: 0.3,
      maxTokens: 1000,
    ...
    assert(
      invalidOutput.errors.some((e) => e.includes("Invalid output format")),
    );

    const invalidEngine = validateConfig({
      engine: "invalid",
      output: "markdown",
      temperature: 0.3,
      maxTokens: 1000,
    ...
    const invalidTemp = validateConfig({
      engine: "auto",
      output: "markdown",
      temperature: 3,
      maxTokens: 1000,
